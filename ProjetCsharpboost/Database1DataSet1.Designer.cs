...
namespace ProjetCsharpboost {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientRow AddClientRow(string nom, string prenom, string adresse, string phone) {
...
namespace ProjetCsharpboost.Database1DataSet1TableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Client] WHERE (([Id] = @Original_Id) AND ([nom] = @Original_no" +
                "m) AND ([prenom] = @Original_prenom) AND ([adresse] = @Original_adresse) AND ([p" +
                "hone] = @Original_phone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Client] ([nom], [prenom], [adresse], [phone]) VALUES (@nom, @p" +
                "renom, @adresse, @phone);\r\nSELECT Id, nom, prenom, adresse, phone FROM Client WH" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Client] SET [nom] = @nom, [prenom] = @prenom, [adresse] = @adresse, [phone] = @phone WHERE (([Id] = @Original_Id) AND ([nom] = @Original_nom) AND ([prenom] = @Original_prenom) AND ([adresse] = @Original_adresse) AND ([phone] = @Original_phone));
SELECT Id, nom, prenom, adresse, phone FROM Client WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjetCsharpboost.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nom, prenom, adresse, phone FROM dbo.Client";
        ...
        public virtual int Fill(Database1DataSet1.ClientDataTable dataTable) {
        ...
        public virtual Database1DataSet1.ClientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.ClientDataTable dataTable = new Database1DataSet1.ClientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.ClientDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_nom, string Original_prenom, string Original_adresse, string Original_phone) {
        ...
        public virtual int Insert(string nom, string prenom, string adresse, string phone) {
            if ((nom == null)) {
        ...
        public virtual int Update(string nom, string prenom, string adresse, string phone, int Original_Id, string Original_nom, string Original_prenom, string Original_adresse, string Original_phone, int Id) {
            if ((nom == null)) {
                throw new global::System.ArgumentNullException("nom");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nom, string prenom, string adresse, string phone, int Original_Id, string Original_nom, string Original_prenom, string Original_adresse, string Original_phone) {
            return this.Update(nom, prenom, adresse, phone, Original_Id, Original_nom, Original_prenom, Original_adresse, Original_phone, Original_Id);
        }
    }
